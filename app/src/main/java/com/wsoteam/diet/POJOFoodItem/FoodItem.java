...
public class FoodItem extends SugarRecord {
    ...
    public FoodItem(String name, String description, String composition, String properties, String calories, String protein, String fat, String carbohydrates, String url_of_images) {
        this.name = name;
