...
public class Dinner extends SugarRecord {
    private String name;
    ...
    public Dinner(String name, String urlOfImages, int calories, int carbohydrates, int protein, int fat, int day, int month, int year) {
        this.name = name;
