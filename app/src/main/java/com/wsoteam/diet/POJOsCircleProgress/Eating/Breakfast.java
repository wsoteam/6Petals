...
public class Breakfast extends SugarRecord {
    private String name;
    ...
    public Breakfast(String name, String urlOfImages, int calories, int carbohydrates, int protein, int fat, int day, int month, int year) {
        this.name = name;
